...
def tiles(x, y, z):
    ...
    for row in range(numRows):
        for col in range(numRows):
            ...
            # TODO: the logic of intepretation seems oversimplified with higher zoomlevel, maybe use different method based on zoomlevel?
    ...
    img.save(tmpPng, 'png')
    tmpPng.seek(0)
    return send_file(tmpPng, mimetype='image/png')
